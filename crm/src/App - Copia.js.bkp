  ...
  const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            if (error.code === 'auth/popup-closed-by-user') {
                ...
                console.warn('Tentativa de login Google cancelada devido a múltiplas solicitações simultâneas.');
            } else {
        ...
        {showPasswordReset ? (
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col gap-4 pt-2">
                    ...
                    <Button onClick={handleGoogleSignIn} variant="secondary" disabled={isGoogleSigningIn}>
                        ...
                        {isGoogleSigningIn ? 'Entrando...' : 'Entrar com Google'}                    </Button>
                </div>
            </div>
        )}
      </Modal>
